...
const contactLinks = [
  {
    title: "Email",
    value: "dennis@heyer.dev",
    href: "mailto:dennis@heyer.dev",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  {
    title: "GitHub",
    value: "github.com/dennisheyer",
    href: "https://github.com/dennisheyer",
    icon: (
  ...
  {
    title: "LinkedIn",
    value: "linkedin.com/in/dennisheyer",
    href: "https://linkedin.com/in/dennisheyer",
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
